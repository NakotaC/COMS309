...
public class JsonArrReqActivity extends AppCompatActivity {
    ...
    private static final String URL_JSON_ARRAY = "https://ef1121ad-2002-4195-9fa4-b838cf616118.mock.pstmn.io/JSONArrayTest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(JsonArrReqActivity.this, MainActivity.class));
            }
        });
    }
