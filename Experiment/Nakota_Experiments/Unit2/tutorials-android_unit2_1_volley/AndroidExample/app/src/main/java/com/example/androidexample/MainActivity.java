...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button strBtn, jsonObjBtn, jsonArrBtn, imgBtn, playerBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerBtn = findViewById(R.id.TurnReq);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.TurnReq) {
                startActivity(new Intent(MainActivity.this, PlayerTurnRequest.class));
        }
    }
}