...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toastBtn.setText("Free Toast!");

        /* extract data passed into this activity from another activity */
        Bundle extras = getIntent().getExtras();
        if(extras == null) {
            messageText.setText("Intent Example");
        } else if(!extras.getBoolean("TOGGLE")){
            int numVal = extras.getInt("NUM");
            String number = extras.getString("NUM");  // this will come from LoginActivity
            messageText.setText("The number was " + number);
        }else{
            int numVal = extras.getInt("NUMVAL");
            String number = extras.getString("NUM");  // this will come from LoginActivity
            char c = (char) numVal;
            messageText.setText("The number was " + number + " which is " +  c + " in ASCII");
        }
        ...
        toastBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast toast = Toast.makeText(MainActivity.this, "Ha! Not that kind of toast", Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
