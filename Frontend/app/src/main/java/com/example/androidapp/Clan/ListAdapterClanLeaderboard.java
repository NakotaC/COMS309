 ...
 * user object.
 */
public class ListAdapterClanLeaderboard extends ArrayAdapter<ClanLeaderboardItemObject> {
     ...
     * @param items
     */
    public ListAdapterClanLeaderboard(Context context, List<ClanLeaderboardItemObject> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ClanLeaderboardItemObject item = getItem(position);

        // Check if an existing view is being reused, otherwise inflate the view
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_clanleaderboard, parent,
                    false);
        }
